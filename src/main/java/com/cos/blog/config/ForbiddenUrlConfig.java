...
//		System.out.println("getRequestURI : " + request.getRequestURI());			// URI : 끝에 context 주소만 나옴
		...
		if(request.getRequestURI().equals("/project4/") || request.getRequestURI().equals("/project4/index.jsp") || request.getRequestURI().equals("/project4/user/jusoPopup.jsp") || request.getRequestURI().equals("/project4/user/searchUsername.jsp") || request.getRequestURI().equals("/project4/user/searchPassword.jsp")) {
