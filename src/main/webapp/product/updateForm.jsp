...
<h1 style="text-align: center">
	<div class="d-flex justify-content-center">
		...
		<div style="color: #353A3F; font-weight: bold">상품 수정</div>
	</div>
</h1>
<br>
<br>
...
<div class="container" style="text-align: center">
	<form action="/project4/product?cmd=update" method="POST" name="update"  enctype="multipart/form-data">
		...
		<div class="form-group" >
			<div class="material-icons-input" style="width: 421px">
			    ...
			    <input type="text" name="brand" id="brand" class="form-control" value="${products.brand }" placeholder="브랜드를 입력하세요"  required/>
			</div>
		</div>
		...
		<div class="form-group" >
			<div class="material-icons-input" style="width: 421px">
			    ...
			    <input type="text" name="content" id="content" class="form-control" value="${products.content }" placeholder="제품에 대해 설명해주세요" required/>
			</div>	
		</div>
		...
		<div class="form-group" >
			<div class="material-icons-input" style="width: 421px">
			    ...
			    <input type="text" name="price" id="price" class="form-control" value="${products.price }"placeholder="상품 금액을 입력하세요 (숫자만 입력)" required/>
			</div>	
		</div>
		...
		<button type="button" class="btn btn-primary" style="width: 128px" onclick="nullCheck()">수정 완료</button>
	</form>
</div>
